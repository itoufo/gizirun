...
function LoginForm() {
  ...
  const callbackUrl = searchParams.get('callbackUrl') || '/transcripts'
    ...
    <>
        ...
        <div className="rounded-lg bg-green-50 p-4 text-center text-sm text-green-600">
          {confirmEmail ? (
            <>
              ...
              <p className="mt-1">メール内のリンクをクリックして登録を完了してください。</p>
            </>
          ) : (
      ...
      <form onSubmit={handleCredentialsLogin} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full rounded-lg bg-primary-600 px-4 py-3 text-white transition hover:bg-primary-700 disabled:opacity-50"
        >
